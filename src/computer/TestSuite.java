...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully(){
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "Lina");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"), "Pander");
        sendTextToElement(By.name("BillingNewAddress.Email"), "pander123@gmail.com");
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='BillingNewAddress_CountryId']"), "133");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "London");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address1']"), "1, pool Street");
       ...
       // 2.28 Fill all the details
        sendTextToElement(By.name("CardholderName"), "Lina pander");
